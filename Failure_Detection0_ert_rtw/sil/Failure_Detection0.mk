###########################################################################
## Makefile generated for component 'Failure_Detection0'. 
## 
## Makefile     : Failure_Detection0.mk
## Generated on : Sun Mar 09 03:14:17 2025
## Final product: .\Failure_Detection0.exe
...
PRODUCT_NAME              = Failure_Detection0
MAKEFILE                  = Failure_Detection0.mk
...
MODELREF_LINK_RSPFILE     = Failure_Detection0_ref.rsp
COMPILER_COMMAND_FILE     = Failure_Detection0_comp.rsp
CMD_FILE                  = Failure_Detection0.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = .\Failure_Detection0.exe
...
DEFINES_STANDARD = -DMODEL=Failure_Detection0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ..\Failure_Detection0.obj

LIBS = $(START_DIR)\Failure_Detection0_ert_rtw\coderassumptions\lib\Failure_Detection0_ca.lib
...
xil_interface.obj : "$(START_DIR)\Failure_Detection0_ert_rtw\sil\xil_interface.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Failure_Detection0_ert_rtw\sil\xil_interface.c"


sil_main.obj : "$(START_DIR)\Failure_Detection0_ert_rtw\sil\sil_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Failure_Detection0_ert_rtw\sil\sil_main.c"
