/*
 * Failure_Detection0_sbs.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: Failure_Detection0
 * Component Simulink Path: Failure_Detection0
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                Failure_Detection0_sbs
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("Failure_Detection");
      mxArray *rhs[3];
      const char * simulinkBlockPath = ssGetPath(S);
      rhs[ 0 ] = mxCreateString(
        "@coder.connectivity.SimulinkInterface.getSILPILInterface");
